...
def _build_vocab(filename):
  ...
  counter = collections.Counter(data).most_common(10000)
  ...
  # for i in words[-100:]:
  #   print(i)
  word_to_id = {w : index for (index, w) in enumerate(w for w, count in counter)}
...
def _file_to_word_ids(filename, word_to_id):
  ...
  #     ls.append(word_to_id[word])
  #   else:
  #     ls.append(word_to_id['<unk>'])
  # return ls
